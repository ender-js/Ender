var ENDER = {
    ...
    , docs: {
      ...
      , compile: '- compile:\n'.yellow +
          ...
          '  + options:\n'.red +
          '  - ' + '--use'.yellow + ' (--use, -u) target a specific ender package (without use, ender defaults to local ender.js || ender.min.js)\n' +
          '    + example: ' + '$ ender compile -u ../public/js/mootools.js app.js\n'.cyan +
          '  - ' + '--level'.yellow + ' (--level) closure compiler compilation level (one of advanced, simple, whitespace, defaults to advanced)\n' +
          '    + example: ' + '$ ender compile --level simple\n\n'.cyan

var ENDER = {
    ...
    , docs: {
      ...
      , overview: '\nMethods'.red + ' - for more info on any one method run ' + '$ ender method --help\n'.cyan +
          ...
          'Options\n'.red +
          '-------\n' +
          'All the options used by above methods can take default parameters from a local ' + '.ender.json'.yellow + ' file\n' +
          'For example, put ' + '{"output": "./public/js/ender"}'.yellow + ' in ' + './.ender.json'.yellow + ' and ' + '$ ender build'.cyan + ' will now act\n' +
          'exactly as ' + '$ ender build --output ./public/js/ender\n\n'.cyan +

var fs = require('fs')
  ...
  , makeTemplateData = function (packageName, sources) {
      return {
  ...
  , SourcePackage = {
        init: function (packageName, parents, packageJSON) {
      ...
      , asString: function (callback) {
          ...
          var root = packageUtil.getPackageRoot(this.parents, this.packageName)
            ...
            , handleSourceData = function (err, sources) {
                ...
                generateSource(
                    packageName
                  , makeTemplateData(packageName, sources)
                  , function (err, source) {
...
module.exports.create = function (parents, packageName, packageJSON) {
  return Object.create(SourcePackage).init(packageName, parents, packageJSON)
}
